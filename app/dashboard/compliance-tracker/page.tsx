...
export default function FeaturePage() {
  const items = [
    { t: "GDPR Data Processing Agreement", d: "Status: Compliant ✅ • Last audit: Jan 15 • Next review: Jul 15", s: "compliant" },
    { t: "SOC 2 Type II", d: "Status: In Progress 🔄 • Auditor: Deloitte • Target: Q2 2026", s: "in-progress" },
    { t: "PCI DSS Level 3", d: "Status: Expired ❌ • Expired: Dec 31, 2025 • Renewal required", s: "expired" },
    { t: "California Consumer Privacy Act", d: "Status: Compliant ✅ • Privacy policy updated Jan 2026", s: "compliant" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Compliance Tracker</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Track regulatory requirements and deadlines</p>
