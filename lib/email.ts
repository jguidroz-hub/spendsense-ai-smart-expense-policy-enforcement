...
const FROM = process.env.EMAIL_FROM || 'SpendSense AI - Smart Expense Policy Enforcement <noreply@example.com>';
const APP_NAME = 'SpendSense AI - Smart Expense Policy Enforcement';
